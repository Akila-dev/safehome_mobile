		...
		<View>
			...
			>
				...
				>
					...
					>
						<FontAwesome5 name="bullhorn" size={20} color={color.button} />
					</View>
					<View
						style={{
							width: "90%",
					...
					>
						<Text style={[text.darkHeader, { fontSize: size.base }]}>
						...
						<Text
							style={[
								text.light,
								{ fontSize: size.sm, marginTop: 8, color: color.highlight },
							]}
						>
			...
			>
				...
				>
					...
					>
						<Text style={[text.light, { fontSize: size.base }]}>
							Lorem ipsum dolor sit amet consectetur. Erat eget integer
							ultricies .
						</Text>
						<Text style={[text.light, { fontSize: size.base, marginTop: 8 }]}>
							18 June 2023, 12:56:39
						</Text>
					</View>
				</View>
