  ...
  return (
    ...
    >
      <ScrollView>
        ...
        >
          <Text style={[styles.header, { color: "#8D4000" }]}>
            Smart Office Lekki
          </Text>
          ...
          <View>
            ...
            <View>
              <View style={[styles.flex, { marginTop: 16 }]}>
                ...
                <View style={styles.flexDisplay}>
                  <Text style={styles.content}>Offer Closing Date</Text>
            ...
            <View>
              <View style={[styles.flex, { marginTop: 16 }]}>
                <View style={styles.flexDisplay}>
                  ...
                  <Text style={styles.contentNairas}>23rd Oct 2023</Text>
                </View>
                <View style={styles.flexDisplay}>
                  <Text style={styles.content}>Payout Time</Text>
                  <Text style={styles.contentNairas}>Capital + profit</Text>
                </View>
              </View>
            </View>
            <View>
              <View style={[styles.flex, { marginTop: 16 }]}>
                <View style={styles.flexDisplay}>
                  ...
                  <Text style={styles.contentNairas}>Completed</Text>
                </View>
                <View style={styles.flexDisplay}>
                  <Text style={styles.content}>Payback Time</Text>
                  <Text style={styles.contentNairas}>06:09am</Text>
                </View>
              </View>
            </View>
            <TouchableOpacity
            ...
            <View>
              <View style={[styles.flex, { marginTop: 16 }]}>
                <TouchableOpacity
                  ...
                  style={[styles.flexDisplays, { borderColor: "#8D4000" }]}
                >
